...
public class DistroDataRequestHandlerTest {
    ...
    public void testHandle() throws NacosException {
        ...
        DistroDataResponse response = distroDataRequestHandler.handle(distroDataRequest.toRequest(), requestMeta);
        ...
        DistroDataResponse response1 = distroDataRequestHandler.handle(distroDataRequest.toRequest(), requestMeta);
        ...
        DistroDataResponse response2 = distroDataRequestHandler.handle(distroDataRequest.toRequest(), requestMeta);
        ...
        DistroDataResponse response3 = distroDataRequestHandler.handle(distroDataRequest.toRequest(), requestMeta);
        Assert.assertEquals(response3.getDistroData(), distroData);
        
        distroDataRequest.setDataOperation(ADD);
        DistroDataResponse response4 = distroDataRequestHandler.handle(distroDataRequest.toRequest(), requestMeta);
